                ...
                <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8 z-10">
                    <div className="md:flex md:justify-between tablet:justify-center z-10">
                        ...
                        <div className=" flex  flex-col gap-5 mb-6 max-w-[40%] tablet:max-w-[100%] tablet:items-center  md:mb-0">
                            <a target="blank" href="https://voip.finance/" className="flex items-center">
                                {/* <img loading="lazy" src={logo1} className="h-[50px] me-3" alt="FlowBite Logo" /> */}
                            ...
                            <div className="flex gap-5" >
                                <a target="blank" href="https://www.youtube.com/@voipfinance"> <img loading="lazy" className=" h-auto w-auto hover:scale-[1.3] transform-scale duration-300" src={youtube} alt="youtube" /> </a>
                                <a target="blank" href="https://www.x.com/voipfinance"> <img loading="lazy" className=" h-auto w-auto hover:scale-[1.3] transform-scale duration-300" src={twiter} alt="twiter" /> </a>
                                <a target="blank" href="https://t.me/voipfinance"> <img loading="lazy" className=" h-auto w-auto hover:scale-[1.3] transform-scale duration-300" src={Telegram} alt="Telegram" /> </a>
                                <a target="blank" href="https://www.instagram.com/voipfinance"> <img loading="lazy" className=" h-auto w-auto hover:scale-[1.3] transform-scale duration-300" src={Instagram} alt="Instagram" /> </a>
                                <a target="blank" href="https://discord.gg/j3rfjhTqh2"> <img loading="lazy" className=" h-auto w-auto hover:scale-[1.3] transform-scale duration-300" src={Medium} alt="Medium" /> </a>
